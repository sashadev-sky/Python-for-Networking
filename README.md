...
from socket import (AF_INET, SO_REUSEPORT, SOCK_STREAM, SOL_SOCKET,
                    SOMAXCONN, create_server, socket)
```
...
Marks the socket referred to by sockfd as a passive socket - meaning  the one you'd informally call the server.

:param backlog: queue limit for incoming connection. Default is 128 but is system dependent.
"""
```
